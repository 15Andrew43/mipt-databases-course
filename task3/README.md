...
Xapian - это бесплатная библиотека с открытым исходным кодом для полнотекстового поиска, впервые выпущенная в 2003 году. Первоначально предназначалась для использования в проекте Omega. Со временем Xapian стал независимым проектом с открытым исходным кодом и привлек сообщество разработчиков.
